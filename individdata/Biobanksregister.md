...
Biobanker i Sverige är en nationell resurs för vård och forskning. De kan användas för  att förstå sjukdomars uppkomst och förlopp, utveckla diagnostik och behandling samt stödja läkemedelsutveckling och kliniska prövningar. 
...
* Provens identifierare (pseudonymiserade koder)

* Provtyp och provvolym

* Provgivare kopplad via kod, med relevanta demografiska och kliniska variabler

* Datum för provtagning och hantering

* Förvaringsplats (till exempel frys, låda, position)

* Samtyckesinformation och villkor

### **Roller och ansvar**

* **Huvudman**: juridiskt ansvar för biobanken, oftast en region.
...
Så får forskare tillgång till prover och data:

1. **Etikprövning**: godkännande från Etikprövningsmyndigheten med syfte, metod och databehov.

2. **Ansökan om tillgång**: skickas till berörd biobank, ofta via biobankens regionala kontaktväg eller via Biobank Sveriges nationella ingång.

3. **Prövning och beslut**: biobanksansvarig bedömer ansökan mot etikgodkännande, lagkrav och praktiska förutsättningar.
...
* Vilka typer av prover som ingår.  
* Kontaktuppgifter för att gå vidare med en formell ansökan.
